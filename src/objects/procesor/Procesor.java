...
public class Procesor {
  ...
  public void debug() {
    ...
    //if(((Clk)clock).isRunning()) {
      ...
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "A3", deRegister.getInputs().get(2).getState(), deRegister.getData().get(2), "RegMemWEV", emRegister.getInputs().get(1).getState() , emRegister.getData().get(1), "RegMemWEV", mwRegister.getInputs().get(1).getState() , mwRegister.getData().get(1));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "Immediate", deRegister.getInputs().get(3).getState(), deRegister.getData().get(3), "A3", emRegister.getInputs().get(2).getState() , emRegister.getData().get(2), "A3", mwRegister.getInputs().get(2).getState() , mwRegister.getData().get(2));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "AluResultMux", deRegister.getInputs().get(4).getState(), deRegister.getData().get(4), "Immediate", emRegister.getInputs().get(3).getState() , emRegister.getData().get(3), "Immediate", mwRegister.getInputs().get(3).getState() , mwRegister.getData().get(3));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "DataWE", deRegister.getInputs().get(5).getState(), deRegister.getData().get(5), "AluResultMux", emRegister.getInputs().get(4).getState() , emRegister.getData().get(4), "AluResultMux", mwRegister.getInputs().get(4).getState() , mwRegister.getData().get(4));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "R1", deRegister.getInputs().get(6).getState(), deRegister.getData().get(6), "DataWE", emRegister.getInputs().get(5).getState() , emRegister.getData().get(5), "DataMemOut0", mwRegister.getInputs().get(5).getState() , mwRegister.getData().get(5));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV20", deRegister.getInputs().get(7).getState(), deRegister.getData().get(7), "R1", emRegister.getInputs().get(6).getState() , emRegister.getData().get(6), "DataMemOut1", mwRegister.getInputs().get(6).getState() , mwRegister.getData().get(6));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV21", deRegister.getInputs().get(8).getState(), deRegister.getData().get(8), "RV20", emRegister.getInputs().get(7).getState() , emRegister.getData().get(7), "DataMemOut2", mwRegister.getInputs().get(7).getState() , mwRegister.getData().get(7));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV22", deRegister.getInputs().get(9).getState(), deRegister.getData().get(9), "RV21", emRegister.getInputs().get(8).getState() , emRegister.getData().get(8), "DataMemOut3", mwRegister.getInputs().get(8).getState() , mwRegister.getData().get(8));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV23", deRegister.getInputs().get(10).getState(), deRegister.getData().get(10), "RV22", emRegister.getInputs().get(9).getState() , emRegister.getData().get(9), "DataMemOut4", mwRegister.getInputs().get(9).getState() , mwRegister.getData().get(9));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV24", deRegister.getInputs().get(11).getState(), deRegister.getData().get(11), "RV23", emRegister.getInputs().get(10).getState() , emRegister.getData().get(10), "DataMemOut5", mwRegister.getInputs().get(10).getState() , mwRegister.getData().get(10));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV25", deRegister.getInputs().get(12).getState(), deRegister.getData().get(12), "RV24", emRegister.getInputs().get(11).getState() , emRegister.getData().get(11), "DataMemOut6", mwRegister.getInputs().get(11).getState() , mwRegister.getData().get(11));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV26", deRegister.getInputs().get(13).getState(), deRegister.getData().get(13), "RV25", emRegister.getInputs().get(12).getState() , emRegister.getData().get(12), "DataMemOut7", mwRegister.getInputs().get(12).getState() , mwRegister.getData().get(12));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV27", deRegister.getInputs().get(14).getState(), deRegister.getData().get(14), "RV26", emRegister.getInputs().get(13).getState() , emRegister.getData().get(13), "AluResult0", mwRegister.getInputs().get(13).getState() , mwRegister.getData().get(13));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "AluControl", deRegister.getInputs().get(15).getState(), deRegister.getData().get(15), "RV27", emRegister.getInputs().get(14).getState() , emRegister.getData().get(14), "AluResult1", mwRegister.getInputs().get(14).getState() , mwRegister.getData().get(14));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "AluVectorialMux", deRegister.getInputs().get(16).getState(), deRegister.getData().get(16), "AluResult0", emRegister.getInputs().get(15).getState() , emRegister.getData().get(15), "AluResult2", mwRegister.getInputs().get(15).getState() , mwRegister.getData().get(15));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV10", deRegister.getInputs().get(17).getState(), deRegister.getData().get(17), "AluResult1", emRegister.getInputs().get(16).getState() , emRegister.getData().get(16), "AluResult3", mwRegister.getInputs().get(16).getState() , mwRegister.getData().get(16));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV11", deRegister.getInputs().get(18).getState(), deRegister.getData().get(18), "AluResult2", emRegister.getInputs().get(17).getState() , emRegister.getData().get(17), "AluResult4", mwRegister.getInputs().get(17).getState() , mwRegister.getData().get(17));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV12", deRegister.getInputs().get(19).getState(), deRegister.getData().get(19), "AluResult3", emRegister.getInputs().get(18).getState() , emRegister.getData().get(18), "AluResult5", mwRegister.getInputs().get(18).getState() , mwRegister.getData().get(18));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV13", deRegister.getInputs().get(20).getState(), deRegister.getData().get(20), "AluResult4", emRegister.getInputs().get(19).getState() , emRegister.getData().get(19), "AluResult6", mwRegister.getInputs().get(19).getState() , mwRegister.getData().get(19));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV14", deRegister.getInputs().get(21).getState(), deRegister.getData().get(21), "AluResult5", emRegister.getInputs().get(20).getState() , emRegister.getData().get(20), "AluResult7", mwRegister.getInputs().get(20).getState() , mwRegister.getData().get(20));
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV15", deRegister.getInputs().get(22).getState(), deRegister.getData().get(22), "AluResult6", emRegister.getInputs().get(21).getState() , emRegister.getData().get(21), "", "", "");
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV16", deRegister.getInputs().get(23).getState(), deRegister.getData().get(23), "AluResult7", emRegister.getInputs().get(22).getState() , emRegister.getData().get(22), "", "", "");
      System.out.printf("%-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s | %-10.10s %-10.10s %-10.10s%n", "", "", "", "", "", "", "RV17", deRegister.getInputs().get(24).getState(), deRegister.getData().get(24), "", "", "", "", "", "");
